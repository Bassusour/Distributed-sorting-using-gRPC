...
final case class HelloReply(
    ...
    def companion = hello.HelloReply
    // @@protoc_insertion_point(GeneratedMessage[HelloReply])
}

object HelloReply extends scalapb.GeneratedMessageCompanion[hello.HelloReply] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[hello.HelloReply] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): hello.HelloReply = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[hello.HelloReply] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = hello.HelloReply(
    message = ""
  )
  implicit class HelloReplyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, hello.HelloReply]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, hello.HelloReply](_l) {
  ...
  def of(
    message: _root_.scala.Predef.String
  ): _root_.hello.HelloReply = _root_.hello.HelloReply(
    message
  )
