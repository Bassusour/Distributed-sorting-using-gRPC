...
object GreeterGrpc {
  val METHOD_SAY_HELLO: _root_.io.grpc.MethodDescriptor[com.example.protos.hello.HelloRequest, com.example.protos.hello.HelloReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(com.example.protos.hello.HelloProto.javaDescriptor.getServices().get(0).getMethods().get(0)))
      .build()
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def scalaDescriptor: _root_.scalapb.descriptors.ServiceDescriptor = com.example.protos.hello.HelloProto.scalaDescriptor.services(0)
